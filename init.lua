...
require('lazy').setup({
  ...
  -- Uncomment nvim-tree if you prefer
  {
...
local userdefined = vim.api.nvim_create_user_command
...
userdefined("Memo", function()
  vim.cmd([[split | wincmd j | resize 20 | e ~/memo.md ]])
end, {})

userdefined("Task", function()
  vim.cmd([[split | wincmd j | resize 20 | e ~/tasks.md ]])
end, {})
...
userdefined("Unix", function()
  vim.cmd([[:set ff=unix]])
  vim.cmd([[:%s/\r//g]]) -- remove newline character
end, {})

-- write user defined snippets inside "~/.config/nvim/lua/snippets" dir
-- require("luasnip.loaders.from_lua").load({ paths = "~/.config/nvim/lua/snippets" })
userdefined("Snippet", function()
  -- check snippet file name
  vim.cmd([[:lua require("luasnip.loaders").edit_snippet_files()]])
end, {})
